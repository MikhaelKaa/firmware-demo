...
/*
 * Putty с настройками по умолчанию оправляет \r, на вход ждет \r\n
 */
#define PUTTY
 ...
 * If after receiving ESC character the continuation does not arrive within
 * this interval, the escape state is reset and the pending character is
 * processed as a normal printable character.
 */
